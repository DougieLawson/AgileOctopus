...
int main(int argc, char* argv[])
{
	...
	const char* topic = "octopus/tariff";
	...
	sql="SELECT CONVERT_TZ(period_start, 'UTC', 'Europe/London') as period_start, price FROM Agile_tariffs WHERE period_start >= (NOW() - INTERVAL 29 MINUTE) AND (NOW() + INTERVAL 29 MINUTE) >= period_end ORDER BY period_start;"; 
